---
title: DayPicker
description: Memilih hari dalam seminggu.
group: Form
playground: /playground/day-picker
---
...
```tsx
<DayPicker label="Day Picker" onChange={(nilai) => simpan(nilai)} />
```
...
```tsx
<DayPicker mode="single" />    // satu pilihan, bawaan
<DayPicker mode="multiple" />  // banyak pilihan
<DayPicker mode="range" />     // rentang antara dua nilai
```
