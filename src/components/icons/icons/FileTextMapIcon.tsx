...
const FileTextMapIcon: React.FC<IconProps> = ({
  ...
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    <path
      fill={color}
      d="M22 17.579c0 2.098-1.906 3.386-3.168 4.237l-.218.149a.203.203 0 0 1-.228 0l-.218-.149C16.906 20.965 15 19.677 15 17.58c0-1.975 1.57-3.58 3.5-3.58s3.5 1.605 3.5 3.579Z"
    />
  </svg>
);
