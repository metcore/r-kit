  ...
  const menuItems: RouteType[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/playground/day-picker', label: 'Day Picker' },
        {
          path: '/playground/day-of-month-picker',
          label: 'Day Of Month Picker',
        },
        ...
        { path: '/playground/input-password', label: 'Input Password' },
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/playground/dnd', label: 'Drag and Drop' },
